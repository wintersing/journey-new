...
public class HttpRequest {
    ...
    public void restTemplate(RestTemplate restTemplate){
        HttpRequest.restTemplate = restTemplate;
    }
...
//			}
    ...
    public static String sendGet(String url, String param) {
        String urlNameString = url + "?" + param;
        String result = restTemplate.getForObject(urlNameString, String.class);
	    return result;
    }

    public static JSONObject sendGet1(String url, String param) {
        String urlNameString = url + "?" + param;
        JSONObject result = restTemplate.getForObject(urlNameString, JSONObject.class);
        return result;
    }
